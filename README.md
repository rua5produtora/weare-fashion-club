...
Enquanto não houver posts reais publicados, o Journal apresenta cinco exemplos com imagens locais e texto de demonstração definidos em `dist/data/demo-posts.json`. Eles não aparecem no painel e somem automaticamente da listagem quando o primeiro post real é publicado.
